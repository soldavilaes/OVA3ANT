...
function calcMaxWidth(){for (i = 0; i < wordsG.length; i++) {var actualSize=0;actualSize=$.trim(aforWords(wordsG[i])).length*(42+9);
...
leV=leV+50;if (leV+400>actMaxWidth){leV=0;toV=toV+50;}}
var heiAct=(toV+50).toString()+"px";$("#ardoraAct").css("height",heiAct);
...
function paintbGame(){profG=profG+30+9;var leV=(actMaxWidth-($.trim(aforWords(wordsG[indexG])).length-1)*(30+19))/2;
